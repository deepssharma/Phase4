...
## Business Problem
---------------------------------
* **Piedmont Healthcare group, is looking for hiring a Data Scientist who can build a realistic model to efficiently screen the chest X-rays in pediatric patients that have pneumonia. 
